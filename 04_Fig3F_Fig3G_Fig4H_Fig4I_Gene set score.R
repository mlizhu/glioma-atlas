...
##   Fig. 3G: 179-gene score in GBM
##   Fig. 3G: 68-gene score in IDH-mutant glioma
...
##Fig.1D
p_ALL <- DimPlot(data,reduction = "umap.harmony",label = T,cols = cell_colors,raster = TRUE)

##Fig.3F
P_GBM <- DimPlot(GBM,reduction = "umap.harmony",label = T, cols = cell_colors,raster = TRUE)

##Fig.3F
p_IDHMU  <- DimPlot(IDHMU, reduction = "umap.harmony",label = T,cols = cell_colors,raster = TRUE)

##Fig.4H
P_AC  <- DimPlot(AC, reduction = "umap.harmony",label = T,cols = cell_colors,raster = TRUE)

##Fig.4H
P_OD  <- DimPlot(OD, reduction = "umap.harmony",label = T,cols = cell_colors,raster = TRUE)
